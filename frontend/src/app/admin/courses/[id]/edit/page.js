...
export default function EditCoursePage() {
  ...
  useEffect(() => {
    const loadPageData = async () => {
      try {
        ...
        const [courseResponse, universitiesResponse] = await Promise.all([
          API.get(`/api/courses/admin/${courseId}`),
        ...
        const universitiesData = universitiesResponse.data?.data || {};
        ...
        setForm({
          ...
          duration: course.duration || "To be confirmed",
          studyMode: course.studyMode || "on-campus",
          ...
          intakes: Array.isArray(course.intakes) ? course.intakes : [],
          ...
          academicRequirements: Array.isArray(course.academicRequirements)
            ? course.academicRequirements
            : [],

          admissionRequirements: {
            academics: course.admissionRequirements?.academics || "",
            ielts: course.admissionRequirements?.ielts || "",
            toefl: course.admissionRequirements?.toefl || "",
            pte: course.admissionRequirements?.pte || "",
            duolingo: course.admissionRequirements?.duolingo || "",
            centS: course.admissionRequirements?.centS || "",
            sat: course.admissionRequirements?.sat || "",
            imat: course.admissionRequirements?.imat || "",
            other: course.admissionRequirements?.other || "",
            notes: course.admissionRequirements?.notes || "",
          },

          documentsRequired: Array.isArray(course.documentsRequired)
          ...
          requiresIMAT: Boolean(course.requiresIMAT),
          isMedicineProgramme: Boolean(course.isMedicineProgramme),
          specialNotes: course.specialNotes || "",
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const payload = {
        ...
        isEnglishTaught: form.language.trim().toLowerCase() === "english",
      };
      ...
      router.push(`/admin/courses/${updatedCourse?._id || courseId}`);
  ...
  if (loadingCourse) {
    return (
      <div className="grid min-h-105 place-items-center rounded-2xl border border-border bg-card">
      ...
      <section className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-muted sm:text-base">
            Update the course information shown on the European Dreams website.
          </p>
        </div>
        ...
        <div className="grid gap-5">
          ...
          >
            <input
              ...
              placeholder="Course name | University name"
              maxLength={70}
              className={inputClass}
            />
          </Field>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Toggle
              label="Active course"
              description="Allow this course to appear on the public website."
            ...
            <Toggle
              ...
              description="Show this course in featured course sections."
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-sm font-bold text-foreground">
                  English-taught status
                </h3>

                <p className="mt-1 text-xs leading-5 text-muted">
                  This course will be marked as{" "}
                  <strong className="text-foreground">
                    {form.language.trim().toLowerCase() === "english"
                      ? "English taught"
                      : "not English taught"}
                  </strong>{" "}
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 wrap-break-word text-sm leading-6 text-muted">
              {form.name.trim() || "Untitled course"}

              {form.degreeLevel
                ? ` • ${
                    degreeLevels.find((item) => item.value === form.degreeLevel)
                      ?.label || form.degreeLevel
                  }`
                : ""}
